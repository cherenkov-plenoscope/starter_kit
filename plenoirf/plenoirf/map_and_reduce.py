...
def _assert_deflection(site_particle_deflection):
    for example_key in production.example.EXAMPLE_SITE_PARTICLE_DEFLECTION:
...
def _assert_site(site):
    for _key in production.example.EXAMPLE_SITE:
        assert _key in site


def _assert_particle(particle):
    for _key in production.example.EXAMPLE_PARTICLE:
