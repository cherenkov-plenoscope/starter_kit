    ...
    for ok in ONREGION_TYPES:
        for dk in flux_sensitiviy.differential_sensitivity.SCENARIOS:
            ...
            for obstix in range(num_observation_times):
                critical_signal_rate = flux_sensitiviy.differential_sensitivity.estimate_critical_signal_rate_vs_energy(
                ...
                critical_signal_rate_uu = flux_sensitiviy.differential_sensitivity.estimate_critical_signal_rate_vs_energy(
                ...
                dVdE = flux_sensitiviy.differential_sensitivity.estimate_differential_sensitivity(
                    energy_bin_edges_GeV=energy_bin["edges"],
                    signal_effective_area_m2=Areco,
                    critical_signal_rate_per_s=critical_signal_rate,
                )

                dVdE_uu = flux_sensitiviy.differential_sensitivity.estimate_differential_sensitivity(
                    energy_bin_edges_GeV=energy_bin["edges"],
