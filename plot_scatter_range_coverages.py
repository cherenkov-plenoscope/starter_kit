...
for particle in ['gamma', 'electron', 'proton']:
    ...
    fig.savefig(
        os.path.join(
            out_dir,
            'scatter_radius_thrown_and_triggered_{:s}.png'.format(particle)))
    ...
    fig.savefig(
        os.path.join(
            out_dir,
            'scatter_radius_thrown_and_triggered_{:s}_ratio.png'.format(
                particle)))
    ...
    if 'gamma' not in particle:
        ...
        fig.savefig(
            os.path.join(
                out_dir,
                'scatter_angle_thrown_and_triggered_{:s}.png'.format(
                    particle)))
        ...
        fig.savefig(
            os.path.join(
                out_dir,
                'scatter_angle_thrown_and_triggered_{:s}_ratio.png'.format(
                    particle)))
