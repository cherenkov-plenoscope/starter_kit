...
def run(work_dir):
    ...
    phantom_source_meshes_depth_path = os.path.join(
        work_dir, "phantom_source_meshes_depth.json"
    )
    (
        phantom_source_meshes,
        phantom_source_meshes_img,
        phantom_source_meshes_depths,
    ...
    json_numpy.write(
        phantom_source_meshes_depth_path, phantom_source_meshes_depths
    )
...
def _make_mesh_for_phantom_source(
